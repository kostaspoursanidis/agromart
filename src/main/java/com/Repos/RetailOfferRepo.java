...
public interface RetailOfferRepo extends JpaRepository<RetailOffer, Long>{
	...
	@Query("FROM CivilOffer o WHERE (:p = 'any' OR o.type_of_product= :p) ")  
	public List<RetailOffer> getFilteredCO(@Param("p") String type);
	
	@Query("FROM CivilOffer o WHERE (:p = 'any' OR o.type_of_product= :p) AND o.price_per_kg <= :m")  
	public List<RetailOffer> getFilteredCOMax(@Param("p") String type,@Param("m") Float maxPrice);
	
	@Query("FROM CivilOffer o WHERE (:p = 'any' OR o.type_of_product= :p) ORDER BY o.price_per_kg asc")  
	public List<RetailOffer> getFilteredCOAsc(@Param("p") String type);
	
	@Query("FROM CivilOffer o WHERE (:p = 'any' OR o.type_of_product= :p) ORDER BY o.price_per_kg desc")  
	public List<RetailOffer> getFilteredCODesc(@Param("p") String type);
	
	@Query("FROM CivilOffer o WHERE (:p = 'any' OR o.type_of_product= :p) AND o.price_per_kg <= :m ORDER BY o.price_per_kg asc")  
	public List<RetailOffer> getFilteredCOMaxAsc(@Param("p") String type,@Param("m") Float maxPrice);
	
	@Query("FROM CivilOffer o WHERE (:p = 'any' OR o.type_of_product= :p) AND o.price_per_kg <= :m ORDER BY o.price_per_kg desc")  
