...
public class CartItem {
	...
	private Long civil_offer_id;
	private float kilos_wanted;
	private String status;
	
	public CartItem() {}
	
	public CartItem(Long buyer_id, Long producer_id, Long civil_offer_id, float kilos_wanted, String status) {
		super();
		this.buyer_id = buyer_id;
		this.producer_id = producer_id;
		this.civil_offer_id = civil_offer_id;
